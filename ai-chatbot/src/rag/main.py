...
def rag(query: str) -> str:
    """
    Description:
        retrieve relevant documents for the user's query and generate a
        precise, detail-preserving answer grounded in that context via
        the Gemini model.
    ...
    Returns:
        str: a detailed answer constructed from the retrieved context
    """
